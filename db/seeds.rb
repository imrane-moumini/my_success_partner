...
service1 = Service.create!(user_id: user1.id, name: "Examen conservatoire", price: 30, address: "12 rue Paradis, 13006 Marseille", description: "Vous souhaitez retranscrire votre musique préférée en partition mais n’avez peut-être ni le temps, ni l’expérience pour le faire ? Parfait, je suis là pour vous aider")
